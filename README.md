...
| `data/` | Data dictionary, synthetic schema example, and non-restricted figure matrices |

## Citation

If you use this code, cite the associated manuscript once a DOI is assigned. A versioned archival release will be created for the accepted article.
